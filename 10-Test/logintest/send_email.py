...
def main2():
    TO = ['1175429380@qq.com']
    config = {
        "from": "1175429380@qq.com",
        "from_name": '自动化测试unittest测试框架报告:',
        "to": TO,
        "serverip": "smtp.qq.com",
        "serverport": "465",
        "username": "1175429380@qq.com",
        "password": "rfpbgwhzpzaphhjf"  # QQ邮箱的SMTP授权码
    }

    title = "自动化测试unittest测试框架报告"
    f = open("/Users/healer/Desktop/tt/result.html", 'rb')
    mail_body = f.read()
    f.close()
